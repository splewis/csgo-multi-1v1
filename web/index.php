...
<div class="container">
	<div class="everything">
		...
		if (isset($_GET['id']) && !empty($_GET['id'])){
			...
			$run_query = "SELECT s1.*, (SELECT COUNT(*) FROM $mysql_table AS s2 WHERE s2.rating > s1.rating)+1 AS rank FROM $mysql_table AS s1 WHERE accountID=".(int)$_GET['id']." AND serverID=".(int)$_GET['server_id'];
